...
class ProcessesWindow:
    def __init__(self, master, on_close_callback):
        ...
        self.save_button = tk.Button(self.processes_window, text="Сохранить в файл", command=self.save_to_file)
    ...
    def save_to_file(self):
        file_path = "MyDocuments/processes_info.txt"
        ...
        messagebox.showinfo("Успех", f"Информация о процессах сохранена в файл: {file_path}")
